            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('admin.profile.update')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 text-center">
                        <img src="<?php echo e($user->avatar_url); ?>" alt="<?php echo e($user->name); ?>" class="rounded-circle mb-3" width="100" height="100">
                        <div>
...
unset($__errorArgs, $__bag); ?>" id="bio" name="bio" rows="3"><?php echo e(old('bio', $user->bio)); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/anssary/Desktop/Task/laravel-api-admin-panel/resources/views/admin/auth/profile.blade.php ENDPATH**/ ?>