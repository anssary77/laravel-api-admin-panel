...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Panel'); ?> - Laravel Admin</title>
...
<body>
    ...
    <nav class="sidebar position-fixed d-flex flex-column p-3" style="width: 250px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('chat.index')); ?>" class="nav-link <?php echo e(request()->routeIs('chat.index') ? 'active' : ''); ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.file-manager.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.file-manager.*') ? 'active' : ''); ?>">
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown">
                ...
                <strong><?php echo e(Auth::guard('web')->user()->name ?? 'Admin'); ?></strong>
            </a>
            <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                <li><a class="dropdown-item" href="<?php echo e(route('admin.profile')); ?>">Profile</a></li>
                <li><a class="dropdown-item" href="<?php echo e(route('admin.settings.index')); ?>">Settings</a></li>
                ...
                <div class="navbar-nav ms-auto align-items-center">
                    ...
                    <div class="nav-item dropdown me-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 py-0" aria-labelledby="notificationDropdown" style="width: 300px;">
                            ...
                            <li class="border-top py-2 text-center">
                                <a href="<?php echo e(route('admin.notifications.index')); ?>" class="btn btn-sm btn-link text-primary text-decoration-none">View all</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                            <i class="fas fa-user me-1"></i><?php echo e(Auth::guard('web')->user()->name ?? 'Admin'); ?>
    ...
    <script>
        ...
        // Notification Logic
        const unreadNotificationsUrl = "<?php echo e(route('admin.notifications.unread')); ?>";
        const markAsReadUrl = "<?php echo e(route('admin.notifications.mark-as-read')); ?>";
...
</html><?php /**PATH /Users/anssary/Desktop/Task/laravel-api-admin-panel/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>