<?php $__env->startSection('title', 'User Support Chat'); ?>
            ...
            <div class="card h-100 border-0 shadow-sm">
                ...
                <div class="list-group list-group-flush overflow-auto" style="max-height: 550px;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="list-group-item list-group-item-action user-chat-link py-3 border-bottom" data-user-id="<?php echo e($user->id); ?>" data-user-name="<?php echo e($user->name); ?>">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/anssary/Desktop/Task/laravel-api-admin-panel/resources/views/admin/chat/index.blade.php ENDPATH**/ ?>