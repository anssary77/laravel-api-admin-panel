            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0"><?php echo e(number_format($overviewStats['total_users'])); ?></h2>
                    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card stats-card border-0" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-uppercase mb-2">New Users (<?php echo e($dateRange); ?>d)</h6>
                        <h2 class="mb-0"><?php echo e(number_format($overviewStats['new_users'])); ?></h2>
                    </div>
                    <div class="text-white-50">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0"><?php echo e(number_format($overviewStats['total_activities'])); ?></h2>
                    </div>
                    <div class="text-white-50">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card stats-card border-0" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-uppercase mb-2">Recent Activities (<?php echo e($dateRange); ?>d)</h6>
                        <h2 class="mb-0"><?php echo e(number_format($overviewStats['recent_activities'])); ?></h2>
                    </div>
                    <div class="text-white-50">
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.reports.users')); ?>" class="btn btn-primary">View Users Report</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.reports.activity')); ?>" class="btn btn-info">View Activity Report</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.reports.system')); ?>" class="btn btn-success">View System Report</a>
            </div>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/anssary/Desktop/Task/laravel-api-admin-panel/resources/views/admin/reports/index.blade.php ENDPATH**/ ?>