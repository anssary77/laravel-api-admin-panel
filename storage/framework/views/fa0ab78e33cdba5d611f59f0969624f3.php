...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'User Dashboard'); ?> - Laravel Task</title>
...
<body>
    ...
    <nav class="sidebar position-fixed d-flex flex-column p-3" style="width: 250px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('user.settings')); ?>" class="nav-link <?php echo e(request()->routeIs('user.settings') ? 'active' : ''); ?>">
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown">
                <img src="<?php echo e(Auth::user()->avatar_url); ?>" alt="" class="rounded-circle me-2" width="32" height="32">
                <strong><?php echo e(Auth::user()->name); ?></strong>
            </a>
            <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                <li><a class="dropdown-item" href="<?php echo e(route('user.profile')); ?>">Profile</a></li>
                <li><a class="dropdown-item" href="<?php echo e(route('user.settings')); ?>">Settings</a></li>
                ...
                <div class="navbar-nav ms-auto align-items-center">
                    ...
                    <div class="nav-item dropdown me-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 py-0" aria-labelledby="notificationDropdown" style="width: 300px;">
                            ...
                            <li class="border-top py-2 text-center">
                                <a href="<?php echo e(route('notifications.index')); ?>" class="btn btn-sm btn-link text-primary text-decoration-none">View all</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown">
                            <img src="<?php echo e(Auth::user()->avatar_url); ?>" alt="" class="rounded-circle me-2" width="24" height="24">
                            <span><?php echo e(Auth::user()->name); ?></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2">
                            <li><a class="dropdown-item" href="<?php echo e(route('user.profile')); ?>"><i class="fas fa-user-circle me-2 text-muted"></i>Profile</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('user.settings')); ?>"><i class="fas fa-cog me-2 text-muted"></i>Settings</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <form method="POST" action="<?php echo e(route('admin.logout')); ?>" class="d-inline">
                                    <?php echo csrf_field(); ?>
    ...
    <script>
        // Notification Logic
        const unreadNotificationsUrl = "<?php echo e(route('user.notifications.unread')); ?>";
        const markAsReadUrl = "<?php echo e(route('user.notifications.mark-as-read')); ?>";
        ...
        function markAllAsRead() {
            $.post(markAsReadUrl, { _token: "<?php echo e(csrf_token()); ?>" }, function() {
                loadNotifications();
            });
        }
        ...
        $(document).on('click', '.notification-item', function(e) {
            ...
            $.post(markAsReadUrl, { id: id, _token: "<?php echo e(csrf_token()); ?>" });
        });
        ...
        $(document).ready(function() {
            ...
            setInterval(function() {
                if (!chatWindow.hasClass('active')) {
                    $.get("<?php echo e(route('chat.messages')); ?>", function(messages) {
                        const unreadCount = messages.filter(m => !m.is_read && m.receiver_id == "<?php echo e(Auth::id()); ?>").length;
                        if (unreadCount > 0) {
...
</html><?php /**PATH /Users/anssary/Desktop/Task/laravel-api-admin-panel/resources/views/user/layouts/app.blade.php ENDPATH**/ ?>