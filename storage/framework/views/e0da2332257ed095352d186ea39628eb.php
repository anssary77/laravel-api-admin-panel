                ...
                <form method="POST" action="<?php echo e(route('user.profile.update')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 text-center">
                        <div class="position-relative d-inline-block">
                            <img src="<?php echo e($user->avatar_url); ?>" alt="<?php echo e($user->name); ?>" class="rounded-circle mb-3 border shadow-sm" width="120" height="120">
...
unset($__errorArgs, $__bag); ?>" id="mobile_number" name="mobile_number" value="<?php echo e(old('mobile_number', $user->mobile_number)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="bio" name="bio" rows="4" placeholder="Tell us something about yourself..."><?php echo e(old('bio', $user->bio)); ?></textarea>
...
<?php echo $__env->make('user.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/anssary/Desktop/Task/laravel-api-admin-panel/resources/views/user/profile.blade.php ENDPATH**/ ?>